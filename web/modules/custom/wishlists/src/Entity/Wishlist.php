 ...
 *       "add" = "Drupal\wishlists\Form\WishlistForm",
 *       "edit" = "Drupal\wishlists\Form\WishlistForm",
 *       "delete" = "Drupal\wishlists\Form\WishlistDeleteForm",
 *     },
 *     "access" = "Drupal\wishlists\WishlistAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\wishlists\WishlistHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "wishlist",
...
class Wishlist extends ContentEntityBase implements WishlistInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Wishlist is published.'))
